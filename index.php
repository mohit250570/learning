...
<head>
	<meta charset="utf-8">
	<title> Websites using gradient</title>
	<meta name="viewport" content="width-divice-width, initial-scale=1.0, user-scalable-yes">
...
<body>
	<div id="container">
		<div id="header">
            ...
            <div id="introduction">
                <h3>Do you need help with LEARNING hub?</h3>
                <p>Our website uses an interactive methodology of teaching technologies using the latest web technologies. Your learning experience with us is guaranteed to be intuitive and fun. You will have fun while learning. This is the secret of our outstanding results. Check reviews from our students.</p>
            </div>
            ...
            <footer class="footer">
                <div>
                    <p>LEARNING hub. Copyright &copy; 2018-2020</p>
                </div>
            </footer>
        </div> 
